...
trap "tput reset; stty echo; tput cnorm; echo -e 'Agora experimente executá-lo da seguinte forma:\n\n$ ./NatalComNeve.sh  \n\nOnde Nome1 e Nome2 são seus nomes, sem espaços em branco'; exit" 2
stty -echo
